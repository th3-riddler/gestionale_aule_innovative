        ...
        <div class="card w-max bg-base-300 p-8">
            ...
            <div class="stats bg-base-300 my-20">
                ...
                <div class="stat">
                    ...
                    <div class="stat-value text-primary w-fit">?</div>
                    <div class="stat-desc text-base mt-2 w-fit">Percentuale di PC prenotati rispetto al totale: <span class="text-info font-bold">?%</span></div>
                </div>
                ...
                <div class="stat">
                    ...
                    <div class="stat-value text-base-500 w-fit">?</div>
                    <div class="stat-desc text-base mt-2 w-fit">Percentuale di prenotazioni rispetto al totale: <span class="text-info font-bold">?%</div>
                </div>

                <div class="stat">
                    <div class="stat-figure text-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="inline-block w-8 h-8 stroke-current" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path fill="currentColor" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
                        </svg>
                    </div>
                    <div class="stat-title font-bold text-xl w-fit">Prenotazioni soddisfatte</div>
                    <div class="stat-value text-secondary w-fit">?%</div>
                    <div class="stat-desc text-base w-fit">Numero prenotazioni rimanenti: <span class="text-info font-bold">?</span></div>
                </div>
