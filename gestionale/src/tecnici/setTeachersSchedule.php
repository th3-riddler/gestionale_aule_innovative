...
$rooms = json_decode(file_get_contents("http://127.0.0.1/API/getRooms.php"));
$teachers = json_decode(file_get_contents("http://127.0.0.1/API/getTeachers.php"));
$classes = json_decode(file_get_contents("http://127.0.0.1/API/getClasses.php"));
$schedule = json_decode(file_get_contents("http://127.0.0.1/API/getSchedule.php?room=" . $_SESSION["current_room"]));
